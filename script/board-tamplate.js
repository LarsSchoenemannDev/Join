function loadAddTaskFormIntoOverlay() {
    ...
    formContainer.innerHTML = `<section class="add-task-content">
          <h1 class="h1-content">Add Task</h1>
            ...
            <section class="card">
              ...
              <div>
                <div class="field">
                  ...
                  <div>
                    <input class="input-icon-calender input-Required" id="duedate" type="date" placeholder="dd/mm/yyyy"
                      required min="2025-01-01" max="2030-12-31">
                  </div>
                </div>
              </div>
            </section>
              ...
              <div class="div-field">
                <div class="field">
                  ...
                  <div class="contentwrapper">
                    <button type="button" id="BTNToggelContacts" onclick="toggelContacts()"
                  ...
                  <div class="selectContact" id="selectContact">
                    <div class="initials-circle">LS</div>
                  </div>
                </div>
                <div class="div-field">
                  <div class="field">
                    ...
                    <div id="selectCategoryHtml"></div>
                    <div id="selectCategory" class="dropdown">
                      <div class="category-main">
                        <input type="radio" id="Select task category" name="priorityCategory"
                          value="Select task category" checked onclick="categorySelector()">
                        <label for="Select task category" class="contact-row">Select task category</label>
                        <input type="radio" id="Technical Task" name="priorityCategory" value="Technical Task"
                          onclick="categorySelector()">
                        <label for="Technical Task" class="contact-row">Technical Task</label>
                        <input type="radio" id="User Story" name="priorityCategory" value="User Story"
                          onclick="categorySelector()">
                        <label for="User Story" class="contact-row">User Story</label>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <section class="footer-add-task">
            ...
            <div class="btn-priority-flex">
              <button class="btn-priority  btn-clear">Clear
              ...
              <div>
                <button class="btn-priority btn-priority-flex btn-createTask" onclick=createTask()>Create Task <svg
                    width="24" height="24" viewBox="0 0 24 24" fill="#29ABE2" xmlns="http://www.w3.org/2000/svg">
