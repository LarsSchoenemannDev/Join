...
//===================================
function groupClickListener() {
  document.addEventListener("click", (event) => {
    subtaskBoxClick(event);
    contactsDropdownClick(event);
    categoryDropdownClick(event);
    isValid();
  });
}

function subtaskBoxClick(event) {
...
function contactsDropdownClick(event) {
...
function categoryDropdownClick(event) {
  const dropdown = document.getElementById("selectCategory");
  const button = document.getElementById("categoryBtn");
...
function eventsAddTask() {
  ...
  document
    ...
    .addEventListener("click", categorySelectorCheck);
