...
const passwordConfirmDiv = document.getElementById('confirm-password-container')
const iconPasswordDivMain = document.getElementById('icon_password_switch_main');
const iconPasswordDivConfirm = document.getElementById('icon_password_switch_confirm');
